...
export function EmailIconButton({ email, doctorName, reportContent }: { email: string; doctorName: string; reportContent: string }) {
      ...
      const html = doctorReportEmail({
        ...
        labels: {
          greeting: t.markup("emailGreeting", {
            doctorName: escapedDoctorName,
            strong: (chunks) => `<strong>${chunks}</strong>`,
          }),
          intro: t("emailIntro"),
          disclaimer: t("emailDisclaimer"),
          preheader: t("emailPreheader", { doctorName }),
